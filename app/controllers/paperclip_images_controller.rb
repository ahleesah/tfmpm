class PaperclipImagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @paperclip_image.save
        format.html { redirect_to @paperclip_image, notice: 'Image was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @paperclip_image.update(paperclip_image_params)
        format.html { redirect_to @paperclip_image, notice: 'Image was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to paperclip_images_url, notice: 'Image was successfully deleted.' }
